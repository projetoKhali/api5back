	...
	vacancies := []ent.DimVacancy{
		{
			...
			Location:    "São Paulo",
			OpeningDate: time.Date(2024, 9, 1, 0, 0, 0, 0, time.UTC),
			ClosingDate: time.Date(2024, 9, 30, 0, 0, 0, 0, time.UTC),
		},
		{
			Title:    "Data Scientist",
			DimUsrId: 1, NumPositions: 2, ReqId: 1,
			Location:    "Rio de Janeiro",
			OpeningDate: time.Date(2024, 8, 15, 0, 0, 0, 0, time.UTC),
			ClosingDate: time.Date(2024, 9, 15, 0, 0, 0, 0, time.UTC),
		},
		{
			Title:    "HR Specialist",
			DimUsrId: 2, NumPositions: 1, ReqId: 1,
			Location:    "São Paulo",
			OpeningDate: time.Date(2024, 9, 5, 0, 0, 0, 0, time.UTC),
			ClosingDate: time.Date(2024, 9, 25, 0, 0, 0, 0, time.UTC),
		},
		{
			Title:    "UX Designer",
			DimUsrId: 3, NumPositions: 2, ReqId: 1,
			Location:    "Curitiba",
			OpeningDate: time.Date(2024, 8, 10, 0, 0, 0, 0, time.UTC),
			ClosingDate: time.Date(2024, 9, 10, 0, 0, 0, 0, time.UTC),
		},
		{
			Title:    "Software Engineer",
		...
		},
		{
			...
			OpeningDate: time.Date(2024, 7, 20, 0, 0, 0, 0, time.UTC),
			ClosingDate: time.Date(2024, 8, 20, 0, 0, 0, 0, time.UTC),
		},
		{
			Title:    "HR Specialist",
	...
	processes := []ent.DimProcess{
		{
			...
			InitialDate: time.Date(2024, 8, 1, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 1, 0, 0, 0, 0, time.UTC),
			DimUsrId:    1,
		},
		{
			Title:       "Recrutamento e Seleção - HR Specialist",
			InitialDate: time.Date(2024, 8, 5, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 5, 0, 0, 0, 0, time.UTC),
			DimUsrId:    2,
		},
		{
			Title:       "Gestão de Produto - Product Manager",
			InitialDate: time.Date(2024, 7, 20, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 8, 20, 0, 0, 0, 0, time.UTC),
			DimUsrId:    3,
		},
		{
			Title:       "Experiência do Usuário - UX Designer",
			InitialDate: time.Date(2024, 8, 10, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 10, 0, 0, 0, 0, time.UTC),
			DimUsrId:    4,
		},
		{
			Title:       "Análise de Dados - Data Scientist",
			InitialDate: time.Date(2024, 7, 15, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 8, 15, 0, 0, 0, 0, time.UTC),
			DimUsrId:    5,
		},
		{
			Title:       "Desenvolvimento de Software - Software Engineer e UX Designer",
			InitialDate: time.Date(2024, 8, 15, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 15, 0, 0, 0, 0, time.UTC),
			DimUsrId:    1,
		},
		{
			Title:       "Análise de Dados e Relatórios - Data Scientist e Product Manager",
			InitialDate: time.Date(2024, 8, 20, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 20, 0, 0, 0, 0, time.UTC),
			DimUsrId:    2,
		},
		{
			Title:       "Processo de Recrutamento - HR Specialist e Software Engineer",
			InitialDate: time.Date(2024, 9, 1, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 30, 0, 0, 0, 0, time.UTC),
			DimUsrId:    3,
		},
		{
			Title:       "Estratégia de Produto - Product Manager e UX Designer",
			InitialDate: time.Date(2024, 9, 5, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 10, 5, 0, 0, 0, 0, time.UTC),
			DimUsrId:    4,
		},
		{
			Title:       "Inovação em Dados - Data Scientist e HR Specialist",
			InitialDate: time.Date(2024, 8, 25, 0, 0, 0, 0, time.UTC),
			FinishDate:  time.Date(2024, 9, 25, 0, 0, 0, 0, time.UTC),
			DimUsrId:    5,
		},
	}
